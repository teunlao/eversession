...
describe("agents/claude/tokens countClaudeMessagesTokens", () => {
  ...
  it("counts only the reachable parentUuid chain (Claude Code style)", async () => {
    const values = [
      ...
      { type: "user", uuid: "u1", parentUuid: null, sessionId: "s1", timestamp: "2025-12-18T00:00:00Z", message: { role: "user", content: "OLD" } },
      { type: "assistant", uuid: "a1", parentUuid: "u1", sessionId: "s1", timestamp: "2025-12-18T00:00:01Z", requestId: "r1", message: { role: "assistant", content: [{ type: "text", text: "OLD2" }] } },
      // Reachable segment (leaf)
      { type: "user", uuid: "v1", parentUuid: null, sessionId: "s1", timestamp: "2025-12-18T00:00:02Z", message: { role: "user", content: "NEW" } },
      { type: "assistant", uuid: "b1", parentUuid: "v1", sessionId: "s1", timestamp: "2025-12-18T00:00:03Z", requestId: "r2", message: { role: "assistant", content: [{ type: "text", text: "NEW2" }] } },
    ];
